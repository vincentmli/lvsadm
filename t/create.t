...
ok(1);
Config::Ldirectord->import('-strict');
...
my $cfg = new Config::Ldirectord(syntax=>'ini');
ok($cfg);
...
# to false, (such as "" or 0), Config::Ldirectord wouldn't store them in a file
#

$cfg = Config::Ldirectord->new($ini_file);
ok($cfg);
